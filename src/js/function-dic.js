...
// $(".streamtag").on('click', function(){ event.preventDefault();});
 ...
 var get_searched_tracks = function(x){ $.ajax({ 
	url: `${baseurl}/tracks`,
	method: "GET",
	dateType:"json",
	data: {
    ...
    audio_src = y.stream_url + "?client_id="+ client_id;
    if (artwork == null) {artwork = 'images/Doge_Head_PNG.png'};
    var song_temp = `<div class="grid_point2">
         
         <div class="img_div2"> <span class="retry2">${audio_src}</span> <a class="streamtag" href="#"> <img class="items_img2" src="${artwork}"> </a>
         </div>
    ...
    $(".search_results_div").append(song_temp);
...
$(".grid_point2").on('click',function(x) {
console.log(x);
event.preventDefault(); 
 var item_sound = x.currentTarget.firstElementChild.innerText;
 console.log(item_sound);
...
$(".current_song").attr('src', `https://api.soundcloud.com/tracks/271870602/stream?client_id=8762736d61261497aec348a0aff61e31`);
 ...
 export {get_tracks, getAudio, get_searched_tracks};